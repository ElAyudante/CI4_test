...
<body>
    <section class="letter container p-5 w-50" style="width: 50%!important; padding: 3rem!important;">
        ...
        <div class="bg-gray text-justify p-5" style="background-color: #eeeeee !important; text-align: justify; padding: 3rem!important;">
            <h2 class="text-uppercase fw-bold mb-4" style="font-family: 'Roboto', sans-serif; text-transform: uppercase!important; font-weight: 700!important; margin-bottom: 1.5rem!important;"><img src="cid:" style="height:40px" alt="">Se añadió un nuevo Pokemon <img src="cid:" style="height:40px" alt=""></h2>
