...
<section class="junta app" style="margin-top: 2.1em; margin-bottom: -5.1em; height: 1500;">
  	
	<?php echo view('templates/menu_admin'); ?>


	<div class="container junta" style="width: 70%; margin-right:2em; margin-top: -100em; margin-bottom: -3em; padding-bottom: 3em;">
    <div class="row">
