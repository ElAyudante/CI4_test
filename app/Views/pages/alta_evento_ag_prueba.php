...
<section class="junta app" style="margin-top: 2.1em; margin-bottom: -5.1em; height: auto;">
    ...
    <div class="container" style="width: 70%; padding:0; margin-right:2em; margin-top: -60em;">
		...
		<?php echo form_open('users/register_evento_ajeno'); ?>
			<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group custom-control custom-radio text-uppercase pt-3">
                    <label style="color: #004987; font-weight:500;">Tipo de Evento</label>
                    <input type="radio" class="custom-control-input" name="tipo" id="tipo1">
                    <label class="custom-control-label" for="tipo1" value="Ajeno" style="color: #004987; font-weight:500;">Ajeno</label>
                    <input type="radio" class="custom-control-input" name="tipo" id="tipo2">
                    <label class="custom-control-label" for="tipo2" value="Gratuito" style="color: #004987; font-weight:500;">Gratuito</label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group custom-control custom-radio text-uppercase pt-3">
                    <label style="color: #004987; font-weight:500;">Activo</label>
                    <input type="radio" class="custom-control-input" name="activo" id="activo1">
                    <label class="custom-control-label" for="activo1" value="Si" style="color: #004987; font-weight:500;">Sí</label>
                    <input type="radio" class="custom-control-input" name="activo" id="activo2">
                    <label class="custom-control-label" for="activo2" value="No" style="color: #004987; font-weight:500;">No</label>
                </div>
            </div>
        </div>
