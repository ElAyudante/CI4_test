<div class="container py-5">
    ...
    <div class="text-justify mt-5">
        ...
        <h3 class="text-uppercase fw-bold">¿Qué son las Cookies?</h3>
        ...
        <h3 class="text-uppercase fw-bold">¿Qué tipo de Cookies utiliza esta página web?</h3>
        ...
        <table class="table">
            <thead>
                ...
                <th scope="col">DESCRIPCION / FINALIDAD</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Analitica web</td>
                    <td>@Propias</td>
                    <td>2 años desde que se creo inicialmente o se restableció</td>
                </tr>
                <tr>
                    <td></td>
                    <td>SE DEBE DE CUMPLIMENTAR LA TABLA</td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
        ...
        <h3 class="text-uppercase fw-bold">¿Cómo puede configurar sus Cookies?</h3>
        ...
        <ol>
            ...
            <li><strong>Mozilla Firefox:</strong> Herramientas > Opciones > Privacidad > Historial > Configuración Personalizada.</li></br>
            <p>Para más información, puede consultar el soporte de Mozilla o la Ayuda del navegador.</p>
            <li><strong>Google Chrome:</strong> Configuración > Mostrar opciones avanzadas > Privacidad -> Configuración de contenido.</li></br>
            ...
            <li><strong>Opera:</strong> Configuración > Opciones > Avanzado > Cookies</li></br>
            <p>Para más información, puede consultar el soporte de Opera o la Ayuda del navegador.</p>
            <p>Si usa otro navegador distinto a los anteriores, consulte su pliítica de instalación, uso y bloqueo de cookies.</p>
        </ol>

        <h3 class="text-uppercase fw-bold">¿Qué ocurre si se deshabilitan las Cookies?</h3>
        <p>Algunas funcionalidades de los Servicios o áreas de este sitio web podrían no funcionar correctamente.</p>

        <h3 class="text-uppercase fw-bold">¿Actualizamos nuestra política de Cookies?</h3>
