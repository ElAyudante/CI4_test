    ...
    <div class="container container-curso">
        <div class="row row-cols-lg-2">
                ...
                <a href="<?php echo base_url(),'/'; ?>formacion_detalle" class="text-decoration-none">
                    <div class="cards-curso m-auto">
                        <div class="imgBx-curso">
                            <div>
                                <img style="height:350px;" src="<?php echo base_url(),'/'; ?>assets/uploads/files/cursos/"> <!--- $curso['Archivo'] --->
                            </div>
                        </div>
            ...
            <div class="col-lg-8 text-white mt-5">
                <h3 class="section-subheading curso-tittle text-uppercase" style="margin-top: -3.6em !important; margin-bottom:1em; min-height: 84px"></h3> <!--- $curso['Nombre'] --->
                <p class="text-justify" style="min-height: 120px"></p> <!--- $curso['Descripcion'] --->
                <div class="d-flex justify-content-lg-start justify-content-center pt-4">
                    <a href="<?= base_url('formacion'). '/' ?>" class="text-white"> <!--- $curso['Id'] --->
    ...
    <div class="container container-curso">
        <div class="row row-cols-lg-2">
            <div class="col-lg-8 mt-5 order-lg-1 order-2">
                <h3 style="margin-top: -3.6em !important; margin-bottom:1em; min-height:84px" class="section-subheading curso-tittle-blanco text-uppercase"></h3> <!--- $curso['Nombre'] --->
                <p class="text-justify" style="min-height: 120px"></p> <!--- $curso['Descripcion'] --->
                <div class="d-flex justify-content-lg-start justify-content-center pt-4">
                    <a href="<?= base_url('formacion'). '/' ?>" class="text-white" > <!--- $curso['Id'] --->
            ...
            <div class="col-lg-4 text-white mt-5 order-lg-2 order-1">
                <a href="<?= base_url('formacion/')?>"  class="text-decoration-none"> <!--- $curso['Id'] --->
                    <div class="cards-curso m-auto">
                        <div class="imgBx-curso">
                            <div>
