...
echo 'function posicionTop() { 
	...
	document.getElementById("itMenu3").style.top=document.getElementById("asociados").offsetTop+25;	document.getElementById("itMenu3").style.left=document.getElementById("asociados").offsetLeft+5;

	document.getElementById("itMenu4").style.top=document.getElementById("imagenes").offsetTop+25;	document.getElementById("itMenu4").style.left=document.getElementById("imagenes").offsetLeft+5;
