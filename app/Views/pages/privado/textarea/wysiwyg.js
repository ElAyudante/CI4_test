...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "underline":      ['Underline',            'Subrayado',          imagesDir + 'underline.gif',          imagesDir + 'underline_on.gif'],
	...
	"subscript":      ['Subscript',            'Subíndice',          imagesDir + 'subscript.gif',          imagesDir + 'subscript_on.gif'],
	"superscript":    ['Superscript',          'Superíndice',        imagesDir + 'superscript.gif',        imagesDir + 'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Izquierda',        imagesDir + 'justify_left.gif',       imagesDir + 'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Centrado',      imagesDir + 'justify_center.gif',     imagesDir + 'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Derecha',       imagesDir + 'justify_right.gif',      imagesDir + 'justify_right_on.gif'],
	"unorderedlist":  ['InsertUnorderedList',  'Insertar Lista sin ordenar',imagesDir + 'list_unordered.gif',     imagesDir + 'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Insertar Lista ordenada',  imagesDir + 'list_ordered.gif',       imagesDir + 'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Restar sangría',            imagesDir + 'indent_left.gif',        imagesDir + 'indent_left_on.gif'],
	"indent":         ['Indent',               'Insertar sangría',             imagesDir + 'indent_right.gif',       imagesDir + 'indent_right_on.gif'],
  ...
  "paste":          ['Paste',                'Pegar',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	"forecolor":      ['ForeColor',            'Color de fuente',          imagesDir + 'forecolor.gif',          imagesDir + 'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Color de fondo',          imagesDir + 'backcolor.gif',          imagesDir + 'backcolor_on.gif'],
	...
	"createlink":     ['CreateLink',           'Crear vínculo',         imagesDir + 'insert_hyperlink.gif',   imagesDir + 'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Ver código',         imagesDir + 'view_source.gif',        imagesDir + 'view_source_on.gif'],
	...
	"selectfont":     ['SelectFont',           'Fuente',         imagesDir + 'select_font.gif',        imagesDir + 'select_font_on.gif'],
	"selectsize":     ['SelectSize',           'Tamaño',         imagesDir + 'select_size.gif',        imagesDir + 'select_size_on.gif']
};
