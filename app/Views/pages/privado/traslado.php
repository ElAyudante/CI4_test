...
<!-- *******************************************************-->
<div id="cont_2">
   <h1>Confirmar el  traslado</h1>
    <?php 
			
			if(isset($_POST["enviar"])) {
				
				$sql_con="UPDATE solicitudes_traslado SET Confirmada='1' AND Fecha='".date("Y-m-d H:i:s")."'";
				...
				$cuerpo='<html>
						...
						<table width="100%" style="border:none" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td class="texto" height="350" valign="top">';							
								...
								$cuerpo.="<h1>Confirmaci�n de traslado</h1>\n";
								$cuerpo.="El sistema de ventanilla �nica informa de que la solicitud de traslado est� siendo tramitada por el Colegio Profesional de Logopedas de Cantabria.<br> Si tiene alguna duda al respecto o usted no ha solicitado la baja del colegio, por favor p�ngase en contacto con nosotros.";
					 ...
					 //que se vea en negrita
						...
						$mail->Subject = "Su solicitud de traslado";						
				...
				echo "<p>La solicitud de traslado ha sido confirmada. Se le ha enviado un email al colegiado para informarle.</p>";
				
				
			}
			else {
				
		  $SQL1="SELECT colegiados.Nombre, colegiados.Apellidos, colegiados.Colegiado, colegiados.Email, colegiados.NIF, colegiados.Localidad, colegiados.Provincia, solicitudes_traslado.relColegiado , solicitudes_traslado.Comentarios FROM colegiados, solicitudes_traslado WHERE colegiados.Id=solicitudes_traslado.relColegiado AND colegiados.Id='".$_GET["id"]."'";  		  		  
		  ...
		  if ($num_res1<1) {
			echo "<p>No existen colegiados pendientes de validar</p>\n";  
			  ...
			  echo "<tr> \n
				...
				<td height='25' align='right'><form action='baja.php' method='post'><input type='hidden' name='confirmado' value='".$_GET["id"]."'><input type='hidden' name='email' value='".$campo["Email"]."'><input name='enviar' value='Confirmar traslado' type='submit'></form></td> \n
				</tr>\n";
				
				echo "<tr> \n
				<td width='200' height='25' align='right' class='privada' valign='top'>&nbsp;</td> \n
				<td height='25' align='right'><a href='imprimir_traslado.php?id=".$_GET["id"]."' target='_blank'>PDF para imprimir</a></td> \n
				</tr>\n";
