...
<?php 
			...
			// PROCESAMOS EL FORMULARIO
		  	if (isset($_POST['enviar']) && !$error) {
				...
				$sql="INSERT INTO eventos_ajenos VALUES ('','".$_POST["nombre"]."','".$_POST["descripcion"]."'";
				if(!empty($_FILES["file"]["name"])) $sql.=",'".$nombre_archivo."'"; else $sql.=",''";
				$sql.=",'0', '".@$_POST["activo"]."')";		
	...
	?>
    <h1>Alta de eventos gratuitos</h1>
    <?php if ($error) { echo "<p>".$error."</p>"; }	  ?>
	<form method="post" name="alta_evento_gratis" action="alta_evento_gratis.php" enctype="multipart/form-data">
	<table width="700" style="border:none" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="225" height="25" align="right" class="privada">Archivo Adjunto:&nbsp;&nbsp;</td>
