...
<div id="cont_2">
   <h1>Lista de documentos</h1>
    <?php 
		  ...
		  $SQL1="SELECT * FROM documentos ORDER BY Id DESC";
		  ...
		  if ($num_res1<1) {
			echo "No se han encontrado documentos."; } // fin IF mysql_num_rows($SQL1)<0		
			else {			
			  ...
			  while ($campo=mysql_fetch_array($res_con1)) {
				  ...
				  <a href='edit_documento.php?id=".$campo["Id"]."'>Modificar</a>&nbsp;&nbsp;<a href='borrar_documento.php?id=".$campo["Id"]."' onclick=\"return confirm('�Est� seguro de que desea eliminar esta reclamaci�n?')\">Eliminar</a>
				  </td>
				  </tr>";
