<?php include("configuracion.php");
				...
				$sql="UPDATE pedidos SET Estado='3' WHERE Referencia='".$_GET["id"]."'";
				...
				$cuerpo='<html>
						...
						<table width="100%" style="border:none" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							...
							$cuerpo.="<p>Le enviamos este email para indicarle que su pago con los datos que le detallamos a continuaci�n a cambiado de estado a: <strong>ERRONEO</strong></p>\n";	
