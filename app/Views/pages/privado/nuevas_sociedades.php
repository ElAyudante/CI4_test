...
<div id="cont_2">
   <h1>Lista de Sociedades</h1>
    <?php 
		  ...
		  $SQL1="SELECT * FROM sociedades WHERE Colegiado='0'";  		  		  
		  ...
		  if ($num_res1<1) {
			echo "<p>No existen sociedades pendientes de validar</p>\n";  
			  ...
			  while ($campo=mysql_fetch_array($res_con1)) {
				  ...
				  <span class='pequeno'><a href='ver_sociedad.php?id=".$campo["Id"]."'>Ver ficha</a>&nbsp;&nbsp;<a href='edit_sociedad.php?id=".$campo["Id"]."'>Modificar</a>&nbsp;&nbsp;<a href='borrar_sociedad.php?id=".$campo["Id"]."' onclick=\"return confirm('�Est� seguro de que desea eliminar esta sociedad?')\">Eliminar</a></span>
				  </td>
				  </tr>";
