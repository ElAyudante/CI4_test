...
<div id="cont_2">
   <h1>Lista de Eventos</h1>
    <?php 
		  ...
		  $SQL1="SELECT * FROM eventos ORDER BY Id DESC";
		  ...
		  if ($num_res1<1) {
			echo "No se han encontrado eventos."; } // fin IF mysql_num_rows($SQL1)<0		
			  ...
			  while ($campo=mysql_fetch_array($res_con1)) {
				  ...
				  <a href='edit_evento.php?id=".$campo["Id"]."'>Modificar</a>&nbsp;&nbsp;<a href='borrar_evento.php?id=".$campo["Id"]."' onclick=\"return confirm('�Est� seguro de que desea eliminar este evento?')\">Eliminar</a>
				  </td>
				  </tr>";
