<?php session_start();
	...
	function Footer() {	 	  
		...
		$pdf->Cell(3);	
		$pdf->Cell(80,6,'SOLICITUD DE TRASLADO: ','0','','L');		
		
		$pdf->Ln(10);
		 $SQL1="SELECT colegiados.Nombre, colegiados.Apellidos, colegiados.Colegiado, colegiados.Email, colegiados.NIF, colegiados.Localidad, colegiados.Provincia, solicitudes_traslado.relColegiado , solicitudes_traslado.Comentarios, solicitudes_traslado.Fecha FROM colegiados, solicitudes_traslado WHERE colegiados.Id=solicitudes_traslado.relColegiado AND colegiados.Id='".$_GET["id"]."'";  		  		  
