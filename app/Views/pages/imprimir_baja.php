<?php session_start();
	...
	function Footer() {	 	  
		...
		$pdf->Cell(3);	
		$pdf->Cell(80,6,'SOLICITUD DE BAJA: ','0','','L');		
		
		$pdf->Ln(10);
		 $SQL1="SELECT colegiados.Nombre, colegiados.Apellidos, colegiados.Colegiado, colegiados.Email, colegiados.NIF, colegiados.Localidad, colegiados.Provincia, solicitudes_baja.relColegiado , solicitudes_baja.Comentarios, solicitudes_baja.Fecha FROM colegiados, solicitudes_baja WHERE colegiados.Id=solicitudes_baja.relColegiado AND colegiados.Id='".$_GET["id"]."'";  		  		  
