...
<div id="cont_2">
   <h1>Mensajes Enviados</h1>
    <?php
			...
			$sql_mensaje="SELECT * FROM mensajes WHERE Borrado='0' AND Id NOT LIKE '0' ORDER BY Id DESC";
			...
			if(mysql_num_rows($con_mensaje)>0) {					
				...
				echo "<tr bgcolor='#CCCCCC'> \n";
					echo "<td width='150' height='30'>&nbsp;<strong>Destinatario</strong></td>\n";
					echo "<td width='350' height='30'>&nbsp;<strong>Asunto</strong></td>\n";					
					echo "<td width='150' align='center'>&nbsp;<strong>Fecha</strong></td>\n";
					echo "<td width='40' align='center'>&nbsp;</td>\n";
					echo "</tr>\n";					
				while($estado=mysql_fetch_array($con_mensaje)) {
					echo "<tr> \n";
					echo "<td style='border-bottom:1px solid #CCC'>\n";
						if (strlen($estado["Destinatarios"]) > 50){
						  echo substr($estado["Destinatarios"],0,50).'...';
						}else{
						  echo substr($estado["Destinatarios"],0,50);
						}
					echo"</td>\n";
					echo "<td width='300' height='25' style='border-bottom:1px solid #CCC'>";
					echo "<a href='mensaje_enviado.php?mensaje=".$estado["Id"]."' style='color:#666'>".$estado["Asunto"]."</a>";
					echo "</td>\n";										
