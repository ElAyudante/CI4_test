            ...
            <div class="col-lg-10">
                <div class="container p-5">
                    ...
                    <?php echo form_open('itemCRUD/store_factura', $form_att); ?>
                        ...
                        <div class="row row-cols-lg-3 g-lg-4 cblue">
                        

                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="fecha" value="<?= $data->Fecha ?>" autofocus disabled>
                                </div>
                            </div>
                            ...
                            <div class="col d-flex align-items-center justify-content-center">
                                ...
                                <input class="form-control" type="file" id="formFile" name="archivo" value="<?= $data->Factura ?>">
                            </div>
