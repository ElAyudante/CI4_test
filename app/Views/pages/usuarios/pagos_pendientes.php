  	...
  	<div class="container-fluid row">
        ...
        ?>
			<div class="contrainer p-5">
                ...
                <?php echo form_open("/users/payment_platform/{$pago['ID']}",$form_att); ?>
                <div class="row row-cols-1">
                    ...
                    <div class="col-md border-top  d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary btn-block btn-acceso text-uppercase mt-3">Realizar Pago</button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
			</div>
