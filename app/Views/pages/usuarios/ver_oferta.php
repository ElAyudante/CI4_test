                            ...
                            <div class="card bg-transparent w-auto cards-users-empleo">
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center bg-white">
                                        <div class="card-body">
                                            <h5 class="curso-tittle cblue text-uppercase mb-4"><?php echo $item->Ofrece; ?></h5>
                                            <ul class="objetivos">
                                                <li><?php echo $item->Empresa; ?></li>
                                                <li><?php echo $item->Lugar; ?></li>
                                                <li><?php echo $item->Condiciones; ?></li>
                                            ...
                                            <button type="button" class="btn btn-primary btn-block btn-acceso text-uppercase"><a class="text-white text-decoration-none" href="">Contactar</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
