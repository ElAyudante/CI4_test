   ...
   <h1>Confirmar la baja del colegiado</h1>
    <?php 
			...
			if(isset($_POST["enviar"])) {
				...
				$sql_con="UPDATE solicitudes_cambio SET Confirmada='1' AND Fecha='".date("Y-m-d H:i:s")."'";
						...
						<table width="100%" style="border:none" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td class="texto" height="350" valign="top">';							
								...
								$cuerpo.="El sistema de ventanilla �nica informa de que su cambio de modalidad est� siendo tramitada por el Colegio Profesional de Logopedas de Cantabria.<br> Si tiene alguna duda al respecto o usted no ha solicitado la baja del colegio, por favor p�ngase en contacto con nosotros.";
				...
				echo "<p>La solicitud de cambio ha sido confirmada. Se le ha enviado un email al colegiado para confirmarle su cambio.</p>";
				
				
			}
			else {
				
		  $SQL1="SELECT colegiados.Nombre, colegiados.Apellidos, colegiados.Colegiado, colegiados.Email, colegiados.NIF, colegiados.Localidad, colegiados.Provincia, solicitudes_cambio.relColegiado , solicitudes_cambio.Comentarios FROM colegiados, solicitudes_cambio WHERE colegiados.Id=solicitudes_cambio.relColegiado AND colegiados.Id='".$_GET["id"]."'";  		  		  
		  ...
		  if ($num_res1<1) {
			echo "<p>No existen solicitudes pendientes de validar</p>\n";  
			  ...
			  echo "<tr> \n
				...
				<td height='25' align='right'><form action='cambio.php' method='post'><input type='hidden' name='confirmado' value='".$_GET["id"]."'><input type='hidden' name='email' value='".$campo["Email"]."'><input name='enviar' value='Confirmar cambio' type='submit'></form></td> \n
				</tr>\n";		
				
				echo "<tr> \n
				<td width='200' height='25' align='right' class='privada' valign='top'>&nbsp;</td> \n
				<td height='25' align='right'><a href='imprimir_cambio.php?id=".$_GET["id"]."' target='_blank'>PDF para imprimir</a></td> \n
				</tr>\n";
