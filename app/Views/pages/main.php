  	...
  	<div class="container-fluid row">
		...
		<div class="col-lg-10 text-center">
			<div class="contrainer p-5">
				<h3 class="p-3 text-white text-uppercase fs-1 bg-blue fw-bold mb-0"><img style="width: 60px;" class="img-fluid" src="<?php echo base_url(),'/'; ?>/assets/images/png/logo_white.svg"> ¡Bienvenido al área del administrador!</h3>
