...
<!-- *******************************************************-->
<div id="cont_2">
   <h1>Solicitudes de bajas</h1>
    <?php 
				
		  $SQL1="SELECT colegiados.Id, colegiados.Nombre, colegiados.Apellidos, solicitudes_baja.relColegiado FROM colegiados, solicitudes_baja WHERE colegiados.Id=solicitudes_baja.relColegiado AND solicitudes_baja.Confirmada='0'";  		  		  
		  ...
		  if ($num_res1<1) {
			echo "<p>No existen colegiados pendientes de validar</p>\n";  
			  ...
			  while ($campo=mysql_fetch_array($res_con1)) {
				  ...
				  <span class='pequeno'><a href='baja.php?id=".$campo["Id"]."'>Ver Solicitud</a>&nbsp;&nbsp;<a href='borrar_baja.php?id=".$campo["relColegiado"]."' onclick=\"return confirm('�Est� seguro de que desea eliminar esta solicitud?')\">Eliminar</a></span>
				  </td>
				  </tr>";
