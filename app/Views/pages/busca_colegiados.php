<section class="presentacion p-5 text-lg-start text-center d-flex align-items-center">
    <div class="container">
        <div class="text-white">
            <h1 class="mb-3 title-main align-middle text-uppercase">Colegiados</h1>
            <p class="mb-3 subtitulo-presentacion">Búsqueda de colegiados</p>
        </div>
    </div>
</section>
...
<!-- *******************************************************-->
<div id="cont_2">
<h1 class="text-center">Búsqueda de colegiados</h1>
<?php
...
?>
    <form class="d-flex justify-content-center" method="post" name="busca_colegiados" action="busca_colegiados.php">
        ...
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="inlineCheckbox1">Dirección del Trabajo</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
            <label class="form-check-label" for="inlineCheckbox2">Teléfono</label>
        </div>
        <div class="form-check form-check-inline">
