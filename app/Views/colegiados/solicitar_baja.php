...
nos indicase los motivos para darse de baja. Gracias.</font> \n <br>";
			...
			// PROCESAMOS EL FORMULARIO
		  	if (isset($_POST['enviar']) && !$error) {				 			
				...
				$sql="INSERT INTO solicitudes_baja VALUES ('','".$_SESSION['id_usuario']."','".$_POST["comentarios"]."','','".date("Y-m-d H:i:s")."')";				
					
				$consulta=mysql_query($sql) or die(mysql_error() /*"Error al procesar el formulario. Vuelva a intentarlo. <br>"*/);			

				echo"<h1>Solicitud de baja como Colegiado</h1><p>La solicitud se ha enviado correctamente.</p>";
						...
						<table width="100%" style="border:none" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td class="texto" height="350" valign="top">';							
								...
								$cuerpo.="El sistema de ventanilla �nica informa de que el colegiado ".$mis_datos["Nombre"]." ".$mis_datos["Apellidos"].", con n�mero de colegiado ".$mis_datos["Colegiado"]." ha solicitado la baja como Colegiado.";
	...
	?>
    <h1>Solicitud de baja como Colegiado</h1>
    <?php if (isset($error)) { echo "<p>".$error."</p>"; }	  ?>
	<form method="post" name="solicitud_baja" action="solicitar_baja.php">
	<table width="700" style="border:none" cellpadding="0" cellspacing="0">      

      <tr>
          <td height="25" class="pequeno" colspan="2" style="line-height:  20px;">
            <ol>
                <li>Siguiendo le protocolo marcado por los Estatutos del Colegio Profesional de Logopedas de Cantabria (Art.10/Apdo.Bajas) y con el fin a su vez de velar por la Logopedia para proceder a su baja bien por jubilaci&oacute;n o a petici&oacute;n propia por no ejercer la profesi&oacute;n, ser&aacute; necesario:</li>

                <li>Presentar la demanda a trav&eacute;s del correo electr&oacute;nico decanato@logopedascantabria.org</li>
                <li>Enviar a su vez,  a dicho correo, en archivos adjuntos:
                    <ol>
                        <li>El correspondiente formulario de baja colegial  que deber&aacute; presentarse con todos los apartados rellenados sin excepci&oacute;n. <a href="../FORMULARIO_BAJA.doc">FORMULARIO DE BAJA.</a></li>
                        <li>Certificado oficial que avale el no ejercicio de la logopedia (fotocopia escaneada del contrato, cartilla del paro...)</li>
                    </ol>
                </li>
            </ol>
      ...
      <tr>
          ...
          <td class="pequeno" colspan="2" style="line-height:  20px;">La firma de la solicitud de baja implica el conocimiento y la aceptaci&oacute;n de las siguientes condiciones: 
        <ol>
          <li>Cancelaci&oacute;n de las p&oacute;lizas de seguros de Responsabilidad Civil y de Accidentes (modalidad de ejerciente).</li>
          <li>Imposibilidad legal del ejercicio profesional en el &aacute;mbito privado, sociedades profesionales, centros de logopedia,
          mutuas, fundaciones, asociaciones, hospitales u otros organismos o instituciones no gubernamentales. </li>
          <li>Si fuese su caso, p&eacute;rdida de la Habilitaci&oacute;n obtenida en su d&iacute;a de acuerdo a la D.T. 2&ordf; de la Ley de creaci&oacute;n de este   Colegio Profesional.</li>
          <li>Si la cuota colegial semestral hubiese sido ya pasada al cobro en el momento de la solicitud de baja, no se reintegrar&aacute;
          el tiempo correspondiente al resto del semestre. En el caso de no haber sido emitida todav&iacute;a, se le pasar&aacute; al cobro la
          parte transcurrida hasta el momento de solicitar la baja.           </li>
        </ol></td>
      </tr>
      <tr>
