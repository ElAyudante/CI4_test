...
{ 
    ...
    function paypal_auto_form(){ 
        ...
        $this->button('Pulsa aquí si no eres redirigido automáticamente...'); 
        ...
        echo '<p style="text-align:center;">Por favor, espera. Serás redirigído a la web de Paypal para procesar tu pago.</p>' . "\n"; 
